...
public class ExcelController {
  ...
  @PostMapping("/saveUsingLoad")
  public ResponseEntity<ResponseMessage> saveUsingLoad() {
    String message = "";
      try {
        fileService.saveUsingLoad();
        return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(message));
      } catch (Exception e) {
  ...
  public ResponseEntity<List<Hospital>> getAllTutorials() {
    try {
      List<Hospital> hospitals = fileService.getAllTutorials();
